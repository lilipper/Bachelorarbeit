...
# Change here to your destination folder
models_folder = r"/pfs/work9/workspace/scratch/ma_lilipper-lippert_bachelorthesis_ws/Bachelorarbeit/diffusion_classifier/results_for_thesis_evaluation"

models = {
    #Diffusion Models
    'train_dc_with_original_cn_multichannel_2036332': {
        'path' :'c_dc/train_dc_with_original_cn_multichannel_2036332/sd2-1_img256_float32_251102_1054/split_003/best_dc.pt',
        'classifier' : 'diffusion',
        'adapter' : 'latent',
    },
    'train_dc_with_original_cn_multichannel_load_once_2051652': {
        'path' :'c_dc/train_dc_with_original_cn_multichannel_load_once_2051652/sd2-1_img256_float32_251105_0931/split_002/best_dc.pt',
        'classifier' : 'diffusion',
        'adapter' : 'latent',
    },
    'train_dc_dropout_2d_2112518': {
        'path' :'c_dc/train_dc_dropout_2d_2112518/sd2-1_img256_float32_251112_1918/best_model/best_model.pt',
        'classifier' : 'diffusion',
        'adapter' : 'latent',
    },
    ...
    # vit b32
    'vitb32_dropout_pretrained_2_2153738': {
        'path' :'b_dropout/vitb32_dropout_pretrained_2_2153738/vit_b32_bfloat16_251117_1103/best model/best_checkpoint.pt',
        'classifier' : 'vit_b_32',
        'adapter' : 'cn_wrapper',
    },
    'vitb32_dropout_untrained_2109807': {
        'path' :'b_dropout/vitb32_dropout_untrained_2109807/vit_b32_bfloat16_251112_1219/best model/best_checkpoint.pt',
        'classifier' : 'vit_b_32',
        'adapter' : 'cn_wrapper',
    },
    'vitb32_dropout_pretrained_2_2153739': {
        'path' :'b_dropout/vitb32_dropout_pretrained_2_2153739/vit_b32_bfloat16_251117_1103/best model/best_checkpoint.pt',
        'classifier' : 'vit_b_32',
        'adapter' : 'cn_wrapper',
    },
    # convnext tiny
    'convnext_tiny_dropout_pretrained_2_2153749': {
        'path' :'b_dropout/convnext_tiny_dropout_pretrained_2_2153749/convnext_tiny_bfloat16_251117_1112/best model/best_checkpoint.pt',
        'classifier' : 'convnext_tiny',
        'adapter' : 'cn_wrapper',
    },
    'convnext_tiny_dropout_untrained_2109804': {
        'path' :'b_dropout/convnext_tiny_dropout_untrained_2109804/convnext_tiny_bfloat16_251112_1154/best model/best_checkpoint.pt',
        'classifier' : 'convnext_tiny',
        'adapter' : 'cn_wrapper',
    },
    ...
    # vit b16
    'vitb16_dropout_pretrained_2_2153753': {
        'path' :'b_dropout/vitb16_dropout_pretrained_2_2153753/vit_b16_bfloat16_251117_0644/best model/best_checkpoint.pt',
        'classifier' : 'vit_b_16',
        'adapter' : 'cn_wrapper',
    },
    'vitb16_dropout_pretrained_2_2153747': {
        'path' :'b_dropout/vitb16_dropout_pretrained_2_2153747/vit_b16_bfloat16_251117_1103/best model/best_checkpoint.pt',
        'classifier' : 'vit_b_16',
        'adapter' : 'cn_wrapper',
    },
    ...
    #resnet50
    'resnet50_dropout_pretrained_2_2153748': {
        'path' :'b_dropout/resnet50_dropout_pretrained_2_2153748/resnet50_bfloat16_251117_1103/best model/best_checkpoint.pt',
        'classifier' : 'resnet50',
        'adapter' : 'cn_wrapper',
    },
    'resnet50_dropout_pretrained_2_2153754': {
        'path' :'b_dropout/resnet50_dropout_pretrained_2_2153754/resnet50_bfloat16_251117_0717/best model/best_checkpoint.pt',
        'classifier' : 'resnet50',
        'adapter' : 'cn_wrapper',
    },
    'resnet50_dropout_untrained_2109805': {
        'path' :'b_dropout/resnet50_dropout_untrained_2109805/resnet50_bfloat16_251112_1201/best model/best_checkpoint.pt',
        'classifier' : 'resnet50',
        'adapter' : 'cn_wrapper',
    },
    ...
    'vitb16_pretrained_cn_wrapper_2050294': {
        'path' :'a_cv/vitb16_pretrained_cn_wrapper_2050294/vit_b16_bfloat16_251104_1455/split_004/best.pt',
        'classifier' : 'vit_b_16',
        'adapter' : 'old_cn_wrapper',
    },
    'vitb16_pretrained_cn_wrapper_load_once_2051710': {
        'path' :'a_cv/vitb16_pretrained_cn_wrapper_load_once_2051710/vit_b16_bfloat16_251105_0942/split_009/best.pt',
        'classifier' : 'vit_b_16',
        'adapter' : 'old_cn_wrapper',
    },
    'vitb16_pretrained_cn_wrapper_load_once_more_repeats_2071825': {
        'path' :'a_cv/vitb16_pretrained_cn_wrapper_load_once_more_repeats_2071825/vit_b16_bfloat16_251107_1450/split_008/best.pt',
        'classifier' : 'vit_b_16',
        'adapter' : 'old_cn_wrapper',
    },
    'vitb16_pretrained_cn_wrapper_load_once_more_repeats_2071825_50': {
        'path' :'a_cv/vitb16_pretrained_cn_wrapper_load_once_more_repeats_2071825/vit_b16_bfloat16_251107_1450/split_050/best.pt',
        'classifier' : 'vit_b_16',
        'adapter' : 'old_cn_wrapper',
    },
    # convnext tiny
    'convnext_tiny_pretrained_cn_wrapper_2017198': {
        'path' :'a_cv/convnext_tiny_pretrained_cn_wrapper_2017198/convnext_tiny_bfloat16_251031_0810/split_004/best.pt',
        'classifier' : 'convnext_tiny',
        'adapter' : 'old_cn_wrapper',
    },
    'convnext_tiny_pretrained_cn_wrapper_load_once_2033949': {
        'path' :'a_cv/convnext_tiny_pretrained_cn_wrapper_load_once_2033949/convnext_tiny_bfloat16_251102_0114/split_004/best.pt',
        'classifier' : 'convnext_tiny',
        'adapter' : 'old_cn_wrapper',
    },
    'convnext_tiny_pretrained_cn_wrapper_load_once_more_repeats_2071823': {
        'path' :'a_cv/convnext_tiny_pretrained_cn_wrapper_load_once_more_repeats_2071823/convnext_tiny_bfloat16_251107_1029/split_004/best.pt',
        'classifier' : 'convnext_tiny',
        'adapter' : 'old_cn_wrapper',
    },
    #vit b32
    'vitb32_pretrained_cn_wrapper_2011485': {
        'path' :'a_cv/vit_b_32_pretrained_cn_wrapper_2011485/vit_b32_bfloat16_251031_0810/split_025/best.pt',
        'classifier' : 'vit_b_32',
        'adapter' : 'old_cn_wrapper',
    },
    'vit_b_32_pretrained_cn_wrapper_load_once_2033952': {
        'path' :'a_cv/vit_b_32_pretrained_cn_wrapper_load_once_2033952/vit_b32_bfloat16_251102_0114/split_004/best.pt',
        'classifier' : 'vit_b_32',
        'adapter' : 'old_cn_wrapper',
    },
    'vitb32_pretrained_cn_wrapper_load_once_more_repeats_2071826': {
        'path' :'a_cv/vit_b_32_pretrained_cn_wrapper_load_once_more_repeats_2071826/vit_b32_bfloat16_251107_1451/split_038/best.pt',
        'classifier' : 'vit_b_32',
        'adapter' : 'old_cn_wrapper',
    },
    #resnet50
    'resnet50_train_pretrained_cn_wrapper_2017199': {
        'path' :'a_cv/resnet50_train_pretrained_cn_wrapper_2017199/resnet50_bfloat16_251031_0810/split_012/best.pt',
        'classifier' : 'resnet50',
        'adapter' : 'old_cn_wrapper',
    },
    'resnet50_train_pretrained_cn_wrapper_load_once_2033950': {
        'path' :'a_cv/resnet50_train_pretrained_cn_wrapper_load_once_2033950/resnet50_bfloat16_251102_0114/split_017/best.pt',
        'classifier' : 'resnet50',
        'adapter' : 'old_cn_wrapper',
    },
    'resnet50_train_pretrained_cn_wrapper_load_once_more_repeats_2071824': {
        'path' :'a_cv/resnet50_train_pretrained_cn_wrapper_load_once_more_repeats_2071824/resnet50_bfloat16_251107_1450/split_007/best.pt',
        'classifier' : 'resnet50',
        'adapter' : 'old_cn_wrapper',
    },
    }
...
def main():
    ...
    path ="./results_eval_pipeline_show_results"
    os.makedirs(path, exist_ok=True)
    model_path = os.path.join(path, args.pretrained_model_name)
    os.makedirs(model_path, exist_ok=True)
    class FE: pass
    p_args = FE()
    p_args.pretrained_path = os.path.join(models_folder, model_info['path'])
    p_args.classifier = model_info['classifier']
    p_args.adapter = model_info['adapter']
    p_args.output_dir = model_path
    p_args.split = "test"
    p_args.n_workers = 1
