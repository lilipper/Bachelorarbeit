#!/bin/bash
#SBATCH --job-name=vitb32_dropout_pretrained-scheduler
#SBATCH --partition=gpu_a100_il
#SBATCH --gres=gpu:1
#SBATCH --time=48:00:00
#SBATCH --mem=40GB
#SBATCH --cpus-per-task=16
#SBATCH --output=final_logs/vitb32_dropout_pretrained_scheduler_%j.out
#SBATCH --error=final_logs/vitb32_dropout_pretrained_scheduler_%j.err
...
RUN_NAME="vitb32_dropout_pretrained_scheduler_${SLURM_JOB_ID}"
