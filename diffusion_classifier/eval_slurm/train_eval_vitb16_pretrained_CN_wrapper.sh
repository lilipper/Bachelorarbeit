#!/bin/bash
#SBATCH --job-name=vitb16-pretrained-cn-wrapper
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --time=48:00:00
#SBATCH --mem=40GB
#SBATCH --cpus-per-task=16
#SBATCH --output=final_logs/vitb16_pretrained_cn_wrapper_%j.out
#SBATCH --error=final_logs/vitb16_pretrained_cn_wrapper_%j.err
...
RUN_NAME="vitb16_pretrained_cn_wrapper_${SLURM_JOB_ID}"
