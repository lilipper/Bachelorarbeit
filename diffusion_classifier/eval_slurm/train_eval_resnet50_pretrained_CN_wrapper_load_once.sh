#!/bin/bash
#SBATCH --job-name=resnet50-train-pretrained-cn-wrapper-load-once
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --time=48:00:00
#SBATCH --mem=40GB
#SBATCH --cpus-per-task=16
#SBATCH --output=final_logs/resnet50_train_pretrained_cn_wrapper_load_once_%j.out
#SBATCH --error=final_logs/resnet50_train_pretrained_cn_wrapper_load_once_%j.err
...
RUN_NAME="resnet50_train_pretrained_cn_wrapper_load_once_${SLURM_JOB_ID}"
