...
#SBATCH --output=logs/vit_b_16_train_pretrained_thztorgb_%j.out
#SBATCH --error=logs/vit_b_16_train_pretrained_thztorgb_%j.err
...
RUN_NAME="vit_b_16_train_pretrained_thztorgb_${SLURM_JOB_ID}"
