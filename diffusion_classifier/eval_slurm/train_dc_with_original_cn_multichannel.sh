#!/bin/bash
#SBATCH --job-name=train-dc-with-original-cn-multichannel
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --time=72:00:00
#SBATCH --mem=40GB
#SBATCH --cpus-per-task=16
#SBATCH --output=final_logs/train_dc_with_original_cn_multichannel_%j.out
#SBATCH --error=final_logs/train_dc_with_original_cn_multichannel_%j.err
...
RUN_NAME="train_dc_with_original_cn_multichannel_${SLURM_JOB_ID}"
...
python adapter_multichannel/train_dc_with_original_cn_multichannel.py \
